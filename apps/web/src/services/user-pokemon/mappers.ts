...
export function toUserPokemonDto(userPokemon: UserPokemon): UserPokemonDto {
  return {
    ...
    pokemon: {
      ...
      fullnessDecayPerHour: userPokemon.pokemon.fullnessDecayPerHour,
      moodDecayPerHour: userPokemon.pokemon.moodDecayPerHour,
    },
    currentFullness: userPokemon.currentFullness,
    currentMood: userPokemon.currentMood,
    lastCalculatedAt: userPokemon.lastCalculatedAt.toISOString(),
